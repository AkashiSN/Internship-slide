...
%% 和文用 %%
\usepackage{luatexja} % LuaLaTeXでの和文用
\usepackage{luatexja-fontspec} % フォント指定用
\setmainfont[Ligatures=TeX]{TeXGyreTermes}
\setsansfont[Ligatures=TeX]{TeXGyreHeros}
\setmainjfont[Scale=0.95, BoldFont=meiryob]{meiryo} % メイリオフォント埋め込み
\setsansjfont[Scale=0.95]{meiryob}
\newfontfamily\urlfont{Latin Modern Mono} % URLのフォントを標準に戻す
...
%% タイトル %%
\title[インターンシップを終えて]{インターンシップを終えて} % [略タイトル]{タイトル}
\author[西]{西\ 総一朗} % [略名前]{名前}
\institute[4EJ]{明石高専4年電気情報工学科情報工学コース} % [略所属]{所属}
\date{2018年10月25日} % 日付
